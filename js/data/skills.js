...
export const SKILLS = {
  ...
  arcane_bolt: { id:'arcane_bolt', name:'비전 화살', type:'projectile', tags:['arcane'], color:'#c98bff', mpCost:4,
  ...
  fireball: { id:'fireball', name:'화염구', type:'projectile', tags:['fire'], color:'#ff6a3d', mpCost:6,
  ...
  // ── 연쇄 ──
  chain_spark: { id:'chain_spark', name:'연쇄 번개', type:'chain', tags:['lightning'], color:'#b28bff', mpCost:5,
  ...
  arc_whip: { id:'arc_whip', name:'전격 채찍', type:'chain', tags:['lightning'], color:'#8bb8ff', mpCost:6,
  ...
  spirit: { id:'spirit', name:'정령 드론', type:'summon', tags:['arcane'], color:'#8be0ff', mpCost:3,
  ...
  arcane_storm: { id:'arcane_storm', name:'비전 폭풍(진화)', type:'projectile', tags:['arcane'], color:'#e0a0ff', mpCost:6,
    base:{ damage:24, count:4, speed:9, cooldown:24, pierce:3 }, scale:{ damage:+11 }, maxLevel:5 },
  prism_beam: { id:'prism_beam', name:'프리즘 빔(진화)', type:'beam', tags:['arcane'], color:'#bff8ff', mpCost:5,
