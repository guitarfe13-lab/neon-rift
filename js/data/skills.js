...
export const SKILLS = {
  ...
  arcane_bolt: { id:'arcane_bolt', name:'비전 화살', type:'projectile', tags:['arcane'], color:'#c98bff', mpCost:2, proj:'arrow',
  ...
  ice_shard: { id:'ice_shard', name:'얼음 파편', type:'projectile', tags:['ice'], color:'#9fe8ff', mpCost:2, proj:'lance',
  ...
  rail: { id:'rail', name:'레일건', type:'beam', tags:['physical'], color:'#a0f0ff', mpCost:2, proj:'rail',
  ...
  holy_field: { id:'holy_field', name:'신성 장판', type:'aura', tags:['holy'], color:'#ffe58a', mpCost:4,
  ...
  quake: { id:'quake', name:'대지 진동', type:'aura', tags:['physical'], color:'#d9b38c', mpCost:3,
  ...
  arcane_storm: { id:'arcane_storm', name:'비전 폭풍(진화)', type:'projectile', tags:['arcane'], color:'#e0a0ff', mpCost:6, proj:'arrow',
    base:{ damage:24, count:4, speed:9, cooldown:34, pierce:3 }, scale:{ damage:+11 }, maxLevel:5 },
  prism_beam: { id:'prism_beam', name:'프리즘 빔(진화)', type:'beam', tags:['arcane'], color:'#bff8ff', mpCost:6,
  ...
  blizzard: { id:'blizzard', name:'눈보라(진화)', type:'aura', tags:['ice'], color:'#bfefff', mpCost:6,
    base:{ damage:28, radius:130, cooldown:88 }, scale:{ damage:+12, radius:+10 }, maxLevel:5 },
  tempest: { id:'tempest', name:'폭풍우(진화)', type:'chain', tags:['lightning'], color:'#d0b8ff', mpCost:6,
