...
export const ENEMIES = {
  ...
  tank:     { id:'tank',     name:'탱커',   shape:'square',   sprite:'golem',  color:'#8a7dff', hp:34, speed:0.6, radius:20, damage:10, xp:8,  gold:6,  drop:{ mana:0.28, hp:0.08, coins:2 } },
  shooter:  { id:'shooter',  name:'슈터',   shape:'diamond',  sprite:'eyeball',color:'#4dd2ff', spin:true, hp:10, speed:0.8, radius:14, damage:7,  xp:6,  gold:4, behavior:'shooter', shootCd:110, shotSpeed:3.2, shotRange:360, drop:{ mana:0.22, hp:0.04 } },
  splitter: { id:'splitter', name:'분열체', shape:'circle',   sprite:'cell',   spriteScale:0.85, color:'#66ffb3', hp:14, speed:1.0, radius:16, damage:7,  xp:7,  gold:5, behavior:'splitter', splitInto:'splitling', splitCount:2, drop:{ mana:0.15, hp:0.03 } },
  splitling:{ id:'splitling',name:'분열자',  shape:'circle',   sprite:'cell',   spriteScale:0.7,  color:'#9dffd0', hp:4,  speed:1.5, radius:9,  damage:4,  xp:2,  gold:1,  drop:{ mana:0.04, hp:0.01 } },
  charger:  { id:'charger',  name:'돌진체', shape:'triangle', sprite:'horned', color:'#ff6a3d', hp:16, speed:0.9, radius:16, damage:12, xp:8,  gold:6, behavior:'charger', dashCd:150, dashSpeed:6, dashDur:22, drop:{ mana:0.2, hp:0.06 } },
