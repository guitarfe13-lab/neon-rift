...
export const BOSSES = {
  warden: { id:'warden', name:'감시자', shape:'square', color:'#ff5cc8', boss:true, sprite:'boss', behavior:'boss',
  ...
  hydra: { id:'hydra', name:'히드라', shape:'diamond', color:'#5cff9e', boss:true, sprite:'boss', behavior:'boss',
  ...
  colossus: { id:'colossus', name:'콜로서스', shape:'square', color:'#ffb03d', boss:true, sprite:'boss', behavior:'boss',
